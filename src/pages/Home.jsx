      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        >
          {[
            ...
            <motion.div
              key={stat.label}
              className="card p-4 md:p-6 hover:shadow-soft transform hover:-translate-y-1 transition-all duration-300 backdrop-blur-sm bg-white/95 dark:bg-surface-800/90"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {[
              ...
              <motion.div
                ...
                className="group card p-6 hover:shadow-soft cursor-pointer transition-all duration-300 backdrop-blur-sm bg-white/95 dark:bg-surface-800/90 border border-white/20"
                whileHover={{ y: -4 }}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
