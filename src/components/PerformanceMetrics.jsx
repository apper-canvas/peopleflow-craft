  ...
  return (
    <div className="min-h-screen bg-light-gradient">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="card p-6 backdrop-blur-sm bg-white/95 dark:bg-surface-800/90">
        ...
        {/* Gauge Charts */}
        <motion.div 
          className="card p-6 mb-8 backdrop-blur-sm bg-white/98 dark:bg-surface-800/95"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          {/* Performance Trend */}
          <motion.div 
            className="card p-6 backdrop-blur-sm bg-white/95 dark:bg-surface-800/90"
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
        ...
        <motion.div 
          className="card p-6 backdrop-blur-sm bg-white/98 dark:bg-surface-800/95"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
